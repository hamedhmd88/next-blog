...
const vazirFont = LocalFont({
  src: [
    {
      path: "../../public/fonts/sans/IRANSansWeb_Light.ttf",
      weight: "400",
      style: "normal",
    },
    {
      path: "../../public/fonts/sans/IRANSansWeb_Medium.ttf",
      weight: "500",
      style: "normal",
    },
    {
      path: "../../public/fonts/sans/IRANSansWeb_Bold.ttf",
      weight: "700",
      style: "normal",
    },
    
    {
      path: "../../public/fonts/sans/IRANSansWeb_Black.ttf",
      weight: "900",
      style: "normal",
    },
  ],
